...
<?php
	if( isset($_POST['file']) && ($_POST['file']=='post'))
	{
		...
		mysqli_query($con,"insert into user_post(user_id,post_txt,post_pic,post_time,priority) values('$userInSession','$txt','$img_name','$post_time','$priority');");
	}
	...
	<div class="col-md-7">
		...
		<div >
			...
			<div>
				<table cellspacing="0">
				<?php
					$que_post=mysqli_query($con,"select * from user_post where user_id=$user_id and priority='public' order by post_id desc");
				...
				<tr>
					...
					<td colspan="2" style="padding-top:15;"> 
						<form method="post" enctype="multipart/form-data" name="commenting" onSubmit="return blank_comment_check()" id="cmnt"> 
							...
							<input type="hidden" name="userid" value="<?php echo $user_id; ?>"> 
							<input id="post_img" type="file" name ="file" />
							<input type="submit" value="v" name="commenting" style="width: 21px;" align="right"> 
						</form> 
					</td>
				</tr>
				<tr>
